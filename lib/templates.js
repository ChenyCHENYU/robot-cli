          ...
          monolith: {
            ...
            templates: {
              'robot-admin': {
                ...
                description: '包含完整示例、权限管理、图表组件、最佳实践',
                repo: 'ChenyCHENYU/Robot_Admin',
                features: ['Element Plus', 'Vue Router', 'Pinia', '权限管理', '动态路由', '图表组件'],
                version: 'full',
              ...
              'robot-admin-base': {
                ...
                features: ['Element Plus', 'Vue Router', 'Pinia', '基础布局'],
                version: 'base',
                localTest: true  // 标记为测试模板
              }
            }
          ...
          monorepo: {
            ...
            templates: {
              'robot-monorepo': {
                ...
                description: 'pnpm workspace + 多包管理 + 共享组件库',
                repo: 'ChenyCHENYU/Robot_Monorepo',
                features: ['pnpm workspace', 'shared components', 'build tools', 'CI/CD'],
                version: 'full'
              },
              'robot-monorepo-base': {
                name: 'Robot Monorepo 精简版',
                description: '基础monorepo结构 + 核心配置',
                repo: 'ChenyCHENYU/Robot_Monorepo_Base',
                features: ['pnpm workspace', 'basic structure'],
                version: 'base'
              }
            }
          },
          ...
          multiplatform: {
            ...
            templates: {
              'robot-uniapp': {
                ...
                features: ['多端发布', 'uView UI', '插件集成', '支付功能'],
                version: 'full'
              },
              'robot-uniapp-base': {
          ...
          api: {
            ...
            templates: {
              'robot-nest': {
                ...
                features: ['NestJS', 'TypeORM', 'JWT认证', 'Swagger文档', 'Redis', '微服务'],
                version: 'full'
              },
              'robot-nest-base': {
                name: 'Robot NestJS 精简版',
                description: '基础NestJS + 核心模块',
